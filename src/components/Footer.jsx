...
function Footer({ children, className = 'py-6' }) {
  return (
    <footer className={`relative z-10 text-center text-text-muted text-xs ${className}`}>
      ...
      <a href="/support" className="text-text-muted/60 hover:text-text-secondary transition-colors">Support</a>
      <span className="mx-2 text-text-muted/30">&middot;</span>
      <a href="/terms" className="text-text-muted/60 hover:text-text-secondary transition-colors">Terms</a>
      <span className="mx-2 text-text-muted/30">&middot;</span>
